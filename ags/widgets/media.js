            ...
            children: [
                Widget.Revealer({
                    ...
                    child: Widget.Label({
                        ...
                        const player = mpris.getPlayer(media.preferred) || mpris.getPlayer();
...
export const MediaButton = ({ name, ...rest }) => {
    let deg = 0;
    ...
    return Widget.Button({
        ...
        child: icon,
        on_clicked: () => (opened.popout.value = opened.popout.value === name ? '' : name),
    });
};
